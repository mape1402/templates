namespace DTemplate.Business.Core.Hooks
{
    ...
    public interface IBeforeSaveHook<TRequest, TEntity>
    {
        /// <summary>
        ...
        ValueTask BeforeSaveAsync(CommandHookContext<TRequest, TEntity> context, CancellationToken cancellationToken = default);
    }
}
