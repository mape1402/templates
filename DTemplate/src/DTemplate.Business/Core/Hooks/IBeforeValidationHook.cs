...
{
    /// <summary>
    /// Runs before a command request is validated.
    /// </summary>
    ...
    public interface IBeforeValidationHook<TRequest, TEntity>
    {
        /// <summary>
        ...
        ValueTask BeforeValidationAsync(CommandHookContext<TRequest, TEntity> context, CancellationToken cancellationToken = default);
    }
}
