namespace DTemplate.Business.Core.Commands
{
    ...
    /// <summary>
    /// Provides a base implementation for handling patch commands that do not return a response, including entity retrieval, validation, patching, and updating.
    /// </summary>
    /// <typeparam name="TRequest">The type of the request.</typeparam>
    /// <typeparam name="TEntity">The type of the entity being patched.</typeparam>
    public abstract class PatchCommandHandler<TRequest, TEntity> : NoReturnCommandHandler<TRequest>
        ...
        where TEntity : BaseEntity
    {
        ...
        /// <summary>
        /// Handles the patch command by retrieving, validating, patching, and updating the entity.
        /// </summary>
        /// <param name="request">The request to handle.</param>
        /// <param name="cancellationToken">A token to observe while waiting for the task to complete.</param>
